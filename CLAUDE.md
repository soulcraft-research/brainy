...
The project uses **Conventional Commits** format, automatically generated by Claude AI:

**Usage:**
- `git cc` - Generate and commit with Claude AI analysis of your changes
- `git smart-commit` - Alternative alias (same functionality)

Claude will automatically:
1. Analyze your git diff
2. Generate a properly formatted Conventional Commit message
3. Include appropriate type, scope, and detailed description
4. Add breaking change notices and issue references when relevant
